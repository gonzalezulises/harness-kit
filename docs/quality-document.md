...
| Optional verified autonomy runtime | C | 211 runtime/local-contract tests plus H09 installation4/canary1; full integration640/0; FR-01 literal-filename correction has causal RED, GREEN and independent scoped approval | Broad final review INCOMPLETE after automatic control; H07/H08 positive live review/release backends unimplemented; real-flow acceptance NOT_EXECUTED; unsigned candidate is not owner acceptance |
