...
Actual parser directive tokens are rejected, including an explicit declaration
of the default !! tag handle; implicit defaults and quoted directive text remain
distinguishable.
...
used as handles. Constructors preserve both original verification stops and any
expiry/unavailable-clock stop discovered by their subsequent reinspection. Serialization requires full re-verification on reload. No
