...
54 focused cases and isolated copied-package canary execute; independent H03
review is pending. Numeric lexemes, schema/normalizer/repository bindings and the
