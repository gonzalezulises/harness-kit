...
H07/H08 actual review/production acceptance remains NOT_EXECUTED, and the H09
delivery baseline is CANDIDATE_NOT_ACCEPTED until the owner explicitly accepts
its exact subject. Installation creates no owner key or baseline acceptance.
