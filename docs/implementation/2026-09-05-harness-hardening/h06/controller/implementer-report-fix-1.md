...
# H06 fix round 1/5 — FROZEN again

The original report above remains the exact unchanged prefix (SHA256
`ab5f600ddf46f30456b4ea937471d9139434462e144ffc938a3397af02c9e462`).
Independent review of frozen tree79b2a04f found Critical C1 signature-verifier
shadowing and Medium M1 missing/null observed-defect validation. Both are corrected:
`verifyEnvelope` calls the real crypto verifier; public continuation requires its
strict observed-defect argument. No authority, budget or capability was expanded.

The new8-test file captured actual current-source RED before either fix: seven
assertion failures, also reproduced on the preserved exact source. It covers all
six approval kinds on shared current/recorded paths, genuine vs forged/altered
signatures, historical expiry semantics, missing/null public observation and
actual forged-grant registration/rehashed replay rejection. Original17 tests and
all23 original evidence-manifest entries remain byte-for-byte intact.

Final static exit0; focused runtime21/21; e2e4/4. Exact commands, findings, limits
and source hashes: `docs/implementation/2026-09-05-harness-hardening/h06/fix-1/report.md`.
Report SHA256: `85c0f2f81a8ac08daaf9ea868aa76d76d121b916a42c6f3220e9d708d2a84e3d`.
Fix evidence-manifest SHA256: `9993fcc55a8effe546e7f1134d31b2bf9030bc9f5d77a8a898731e9115d70982`.
All6 final source-manifest entries and all23 fix evidence entries verified.

Root owns independent re-review and the fresh full H03/H04/H05 integration gate.
No index/ref/commit, root state, old evidence, baseline/account action, deployment
or full/startup suite by this worker. The original report's known external
capability and trust limitations remain.

FROZEN. No additional edits until a concrete review fix is assigned.
